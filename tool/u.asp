...
<meta name="description" content="绍兴蓝蜗牛专用版ASP探针ASP组件检测." />
<meta name="author" content="bozoyan" />
<meta name="reply-to" content="yano@qq.com" />
...
.head1 {background-color:#3f8805;width:100%;font-size:36px;color:#ffffff;padding-top:10px; text-align:center; font-family: Georgia, "Times New Roman", Times, serif; font-weight:bold;}
...
<body>
<div class="head1">绍兴蓝蜗牛 ASP 探针</div>
<div class="head2"></div>
...
<table class="info tablex2">
 ...
 <p style="color:#505050;font-size:14px;text-align:center;clear:both; margin-bottom:20px;">&copy;2014 <a href="http://bozoyan.com">Bozoyan.com</a> 版权所有</p>
</div>
</body>
</html>
