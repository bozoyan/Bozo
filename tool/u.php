...
define('NO', '<span style="color: #e74c3c; font-weight : bold;">No</span>');
...
<title>PHP探针</title>
<meta name="keywords" content="PHP探针,PHP组件,UPUPW,UPUPW集成包,kangle,php,ZendOptimizer,ZendGuardLoader,ionCube,eAccelerator,memcache,XCache,WinCache,SendMail" />
<meta name="description" content="绍兴蓝蜗牛专用版PHP探针可检测ZendOptimizer,ZendGuardLoader,ionCube,eAccelerator,memcache,XCache,WinCache和SendMail等PHP组件." />
<meta name="author" content="bozoyan" />
<meta name="reply-to" content="yanbo@qq.com" />
<meta name="copyright" content="绍兴蓝蜗牛" />
<style type="text/css">
<!--
...
<body>
<div class="head1">绍兴蓝蜗牛 PHP 探针</div>
<div class="head2"></div>
...
<td class="fl">
<a target="_blank" href='<?=_SERVER('PHP_SELF')?>?act=phpinfo'>PHP详细信息</a> | <a target="_blank" href="adminer.php">数据库管理</a>
</td>
...
<td colspan="5" class="ec" width="50%">PHP 缓存优化组件</td>
</tr>
<tr>
...
<tr>
<td colspan="8" class="ft">UPUPW KANGLE版<?=PHP_SAPI .' PHP/'.PHP_VERSION?>包含以上部分组件，不同PHP版本包含组件不同，请根据需要在UPUPW面板PHP功能选项配置</td>
</tr>
</table>
<table width="100%" class="inp">
<tr>
